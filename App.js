    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <NavigationContainer>
        <Stack.Navigator>
          ...
          <Stack.Screen name="Nursique" component={SplashScreen} options={{ title: "مرحبا بك فى Nursique" }} />
          <Stack.Screen name="SignUp" component={SignupScreen} options={{ title: " تسجيل " }} />
          <Stack.Screen name="Register" component={Register} options={{ title: " تسجيل كمريض" }} />
          ...
          <Stack.Screen name="patientPost" component={PatientPosts} />
