      ...
      <View style={styles.container}>
        {nurseProfileData && (
          <View style={styles.header}>
            <View style={styles.imageContainer}>
              <Image
                source={{
                  uri: `http://${IP}:3500/${nurseProfileData.profile}`,
                }}
                resizeMode="contain"
            ...
            <View style={styles.headerText}>
              ...
              <View style={styles.nurseRate}>
                ...
                <TouchableOpacity
                  onPress={() => navigation.navigate("NurseNotification")}
                >
                  <Iconbar
                    name="bell-outline"
                    size={30}
                    color="white"
                    style={{ marginRight: -160, marginTop: -100 }}
                  />
                </TouchableOpacity>
              </View>
            </View>
        ...
        <View style={styles.body}>
          ...
          <View style={{ marginBottom: 20 }}>
            ...
            >
              <View style={styles.buttonData}>
                <Icon name="scroll" size={25} style={styles.Icon5} />
            ...
            {showDetails5 && (
              <View style={styles.Profile}>
                ...
                <View>
                  ...
                  {myData.shiftPrice ? (
                    <Text style={styles.ProfileMetaData}>
                      {myData.shiftPrice}
                    </Text>
                  ) : (
                    <Text style={styles.ProfileMetaData}>
          ...
          <View style={{ marginBottom: 20 }}>
            ...
            >
              <View style={styles.buttonData}>
                <Icon name="cogs" size={25} style={styles.Icon2} />
            ...
            {showDetails2 && (
              <View style={styles.editProfile}>
                <TouchableOpacity
                  onPress={() => navigation.navigate("info", { myData })}
                >
                  <Text style={styles.editProfileData}>تعديل الملف الشخصى</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => navigation.navigate("dates", { myData })}
                >
                  <Text style={styles.editProfileData}>أضف مواعيدك</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => navigation.navigate("experience", { myData })}
                >
                  <Text style={styles.editProfileData}>أضف خبراتك</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => navigation.navigate("education", { myData })}
                >
          ...
          <View style={{ marginBottom: 20 }}>
            ...
            >
              <View style={styles.buttonData}>
                <Icon name="certificate" size={25} style={styles.Icon3} />
                ...
                {myData.experience && myData.experience.length > 0 ? (
                  myData.experience.map((item, index) => (
                    <View key={index}>
                      ...
                      {item.title ? (
                        <Text style={styles.experienceMetaData}>
                          {item.title}
                        </Text>
                      ) : (
                  ...
                  <Text style={styles.experienceData}>
                    لا يوجد بيانات خبرات
                  </Text>
                )}
              </View>
            )}
          ...
          <View style={{ marginBottom: 20 }}>
            ...
            >
              <View style={styles.buttonData}>
                <Icon name="book" size={25} style={styles.Icon4} />
              ...
              <View style={styles.education}>
                {myData.education && myData.education.length > 0 ? (
                  myData.education.map((item, index) => (
                    <View key={index}>
                      <Text style={styles.educationData}>التخصص</Text>
                      {item.field ? (
                        <Text style={styles.educationMetaData}>
                          {item.field}
                        </Text>
                      ) : (
                      ...
                      <Text style={styles.educationData}>الدرجة</Text>
                      {item.degree ? (
                        <Text style={styles.educationMetaData}>
                          {item.degree}
                        </Text>
                      ...
                      <Text style={styles.educationData}>الجامعة</Text>
                      {item.school ? (
                        <Text style={styles.educationMetaData}>
                          {item.school}
                        </Text>
          ...
          <View style={{ marginBottom: 30 }}>
            ...
            >
              <View style={styles.buttonData}>
                <Icon name="sign-out-alt" size={25} style={styles.Icon6} />
