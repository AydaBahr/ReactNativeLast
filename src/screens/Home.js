  ...
  useEffect(() => {
    ...
    const loadFont = async () => {
      await Font.loadAsync({
        Droid: require('../../assets/Cairo/Droid.ttf'),
      });
    ...
    loadFont();
    axios.get(`http://${IP}:3500/nurse/top-rated`).then((res) => {
...
<View style={{ 
         ...
         >
<Text
           style={{ marginTop: 20 , marginBottom:30 , fontSize:20  , fontWeight: '700' , borderBottomColor: '#041585' , borderBottomWidth: 2}}
          >
  ...
  <TouchableOpacity key={index} style={{height: 255}}
            ...
            >
              ...
              >
                <View style={{ flexDirection: "row", alignItems: "center" }}>
                  ...
                  <Text style={{ marginLeft: 0 }}> {nurse.rates.toFixed(1)}</Text>
                </View>
                <Text
                  style={{
                    width: "100%",
