          ...
          {(formikProps) => (
            <ScrollView style={styles.form}>
              ...
              <View style={styles.action}>
                ...
                {formikProps.touched.name && !formikProps.errors.name ? (
                  <Animatable.View animation="bounceIn">
                    <Feather name="check-circle" color="darkblue" size={20} />
                  </Animatable.View>
                ) : null}
              </View>
              {formikProps.touched.name && formikProps.errors.name ? (
              ...
              <View style={styles.action}>
                <FontAwesome name="phone" color="darkblue" size={20} />
                <TextInput
  ...
  {formikProps.touched.gender && !formikProps.errors.gender ? (
    <Animatable.View animation="bounceIn">
      ...
      <TouchableOpacity onPress={pickImage1} style={styles.button2}>
        ...
        <Text style={{color:'white' , fontWeight:'bold'}}>شهادة التخرج</Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={pickImage2} style={styles.button2}>
        ...
        <Text style={{color:'white' , fontWeight:'bold'}}>رخصة المهنة</Text>
      </TouchableOpacity>
    </View>
